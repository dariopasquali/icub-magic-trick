...
lie_features, lie_base_right, lie_base_left, tobii_stats = \
    extractLieFeatures(subjects=[3, 4, 6, 7, 8, 10, 11, 12, 13, 14, 15, 16, 18, 20, 21, 24, 25], subject_to_exclude=[], mode=mode, ref_to_base="time", plot=False, save=False, save_root="plots/V2/pupils_{}.png")
lie_features.to_csv("lie_features_humanoids.csv", index=False)
...
lie_plotComparBars(lie_features, feat_cols=lie_feat_cols, save_root="HUMANOIDS/plot/bars_{}.png", save=True)
#print("PLOT POINTS FOR EACH SUBJECT =================================================")
lie_plotPointsAllSubjects(lie_features, feat_cols=points_cols, save_root="HUMANOIDS/plot/{}.png", mode=mode, save=True)
"""
...
# TAKE MAX HEURISIC
sys.stdout = open("HUMANOIDS/reports/take_max_heuristic.txt", "w")
print("======================================================")
...
# PAIRED T TEST
sys.stdout = open("HUMANOIDS/reports/paired_t_test.txt", "w")
print("======================================================")
...
sys.stdout = open("V2_clear_35/reports/multiple_grid_search_log.txt", "w")
...
report.to_csv("V2_clear_35/reports/MGS_report.csv", sep='\t')
"""
